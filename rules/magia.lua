...
● Tokens (A Largura de Banda): Toda habilidade possui um requisito de Tokens, que está diretamente ligado ao seu Rank. Este valor representa a complexidade e o volume de dados do prompt. Seu atributo Tokens representa o nível máximo de acesso à API da "Friend" que você possui simultaneo.(habilidades passivas contam para o uso simultaneo, mas habilidades ativas já ativadas não contam para tal)
